                    ...
                    <div class=" space-y-3">
                        <div>
                            ...
                            <select id="status-pub"
                                ...
                                <option value="diajukan" <?php if($mahasiswa->status === 'diajukan'): ?> selected <?php endif; ?>>Menunggu
                                </option>
                                <option value="diterima" <?php if($mahasiswa->status === 'diterima'): ?> selected <?php endif; ?>>Disetujui
                                </option>
                                <option value="ditolak" <?php if($mahasiswa->status === 'ditolak'): ?> selected <?php endif; ?>>Ditolak
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <div>
                            ...
                            <textarea id="komentar-pub"
                                class="py-3 px-4 block w-full bg-gray-100 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                rows="3" placeholder="Masukan komentar..."><?php echo e($mahasiswa->komentar); ?></textarea>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800 ">
                                            <?php echo e($mahasiswa->tanggal_pengajuan); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->sertifikat_snatia); ?>

                                        </td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->sertifikat_snatia)); ?>"
                                                target="_blank"
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_makalah_snatia); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->turnitin_snatia); ?>

                                        </td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->turnitin_snatia)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->loa_snatia); ?>

                                        </td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->loa_snatia)); ?>" target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_makalah_pkl); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->turnitin_pkl); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->turnitin_pkl)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->loa_pkl); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->loa_pkl)); ?>" target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_hki_pkl); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->tanggal_terbit_hki_pkl); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->manual_book_hki_pkl); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->manual_book_hki_pkl)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->form_pendaftaran_hki_pkl); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->form_pendaftaran_hki_pkl)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->sertifikat_hki_pkl); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->sertifikat_hki_pkl)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_tugas_akhir); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->laporan_tugas_akhir); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->laporan_tugas_akhir)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->berita_acara_ujian_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->berita_acara_ujian_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->lembar_pengesahan_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->lembar_pengesahan_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->file_program_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->file_program_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_jurnal_ta); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->upload_draft_jurnal_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->upload_draft_jurnal_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->file_turnitin_draft_jurnal_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->file_turnitin_draft_jurnal_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        <td
                                            ...
                                            TA </td>
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->loa_publikasi_makalah_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->loa_publikasi_makalah_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->judul_manual_book_ta); ?>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        <td
                                            ...
                                            Manual Book TA</td>
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                            <?php echo e($mahasiswa->upload_file_manual_book_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->upload_file_manual_book_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 ">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100 ">
                                        ...
                                        <td class="w-2/5 px-6 py-4 whitespace-nowrap text-sm text-gray-800 ">
                                            <?php echo e($mahasiswa->upload_file_pendaftaran_hki_ta); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->upload_file_pendaftaran_hki_ta)); ?>"
                                                target="_blank"
                                                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFinish() {
                ...
                const nim_mhs = '<?php echo e($mahasiswa->nim_mhs); ?>';
                ...
                fetch('<?php echo e(route('edit.form.pub')); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\iPublish\resources\views/admin/detailPublikasi.blade.php ENDPATH**/ ?>