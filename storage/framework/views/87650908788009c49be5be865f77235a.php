                                        ...
                                        <select id="dosen-pembimbing"
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php $__currentLoopData = $dosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->nama_dosen); ?>"><?php echo e($row->nama_dosen); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchUserData() {
                fetch('<?php echo e(route('users.hki')); ?>', {
                    headers: {
            ...
            function handleFinish() {
                if (currentStep === 2) {
                    ...
                    fetch('<?php echo e(route('submit.form')); ?>', {
                            method: 'POST',
                            body: formData,
                            headers: {
...
<?php endif; ?>
<?php /**PATH /Users/kadekwiradnyana/Herd/PKL/resources/views/users/hki.blade.php ENDPATH**/ ?>