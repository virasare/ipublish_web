<header class="fixed top-0 left-0 w-full bg-[#DDEBFE] shadow-md z-50">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global" x-data="{ isOpen: false }">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold leading-6 text-gray-900">Registrasi</a>
      </div>
    
    </nav>
    
  </header><?php /**PATH /Users/kadekwiradnyana/Herd/PKL/resources/views/components/navbar.blade.php ENDPATH**/ ?>