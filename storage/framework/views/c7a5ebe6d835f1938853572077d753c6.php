                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            class="py-3 px-4 block w-full bg-gray-100 border-gray-200  rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                                <option value="diajukan" <?php if($mahasiswa->status === 'diajukan'): ?> selected <?php endif; ?>>Menunggu</option>
                                <option value="diterima" <?php if($mahasiswa->status === 'diterima'): ?> selected <?php endif; ?>>Disetujui</option>
                                <option value="ditolak" <?php if($mahasiswa->status === 'ditolak'): ?> selected <?php endif; ?>>Ditolak</option>
                            </select>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <div>
                            ...
                            <textarea id="komentar-hki" class="py-3 px-4 block w-full bg-gray-100 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" rows="3" placeholder="Masukan komentar..."><?php echo e($mahasiswa->komentar); ?></textarea>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800"><?php echo e($mahasiswa->manual_book); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->manual_book)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800"><?php echo e($mahasiswa->fomulir_dokumen); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->fomulir_dokumen)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800"><?php echo e($mahasiswa->sertifikat_hki); ?></td>
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(Storage::disk('google')->url($mahasiswa->sertifikat_hki)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () { 
            ...
            function handleFinish() {
                ...
                const nim_mhs = '<?php echo e($mahasiswa->nim_mhs); ?>'; // Assuming this variable is available in the Blade view
                ...
                fetch('<?php echo e(route('edit.form')); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\iPublish\resources\views/admin/detailHKI.blade.php ENDPATH**/ ?>