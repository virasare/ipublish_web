                                ...
                                <tbody>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(asset('storage/'.$mahasiswa->manual_book)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(asset('storage/'.$mahasiswa->fomulir_dokumen)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="<?php echo e(asset('storage/'.$mahasiswa->sertifikat_hki)); ?>" target="_blank" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:bg-green-600 disabled:opacity-50 disabled:pointer-events-none">
                                                Download
                                            </a>
                                        </td>
                                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PEEKAEL\resources\views/admin/detailHKI.blade.php ENDPATH**/ ?>