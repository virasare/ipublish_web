...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <div class="py-3 flex justify-end">
            <a href="<?php echo e(route('export.publikasi')); ?>" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 focus:outline-none focus:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">
                            ...
                            <tr>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            <div class="grow">
                                                <span class="block text-sm text-gray-500"><?php echo e($row->tanggal_pengajuan); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-1.5">
                                        <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                            href="<?php echo e(route('admin.publikasi.detail', $row->nim_mhs)); ?>">
                                            Lihat
                                        </a>
                                    </div>
                                </td>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\iPublish\resources\views/admin/publikasi.blade.php ENDPATH**/ ?>