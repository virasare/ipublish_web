            ...
            <div class="p-4 bg-gray-50 flex flex-col border border-dashed border-gray-200 rounded-xl overflow-auto">
                ...
                <div class="space-y-4">
                    <div class="sm:col-span-12 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <input type="hidden" id="nip_asli" name="nip_asli" value="<?php echo e($dosen->NIP); ?>">
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <div class="relative">
                                        <input type="text" id="nip" name="nip"
                                            ...
                                            placeholder="Masukkan NIP..." value="<?php echo e($dosen->NIP); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="nidn" name="nidn"
                                        class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="Masukkan NIDN..." value="<?php echo e($dosen->NIDN); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="nama" name="nama"
                                        class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="Masukkan nama dosen..." value="<?php echo e($dosen->nama_dosen); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="telp" name="telp"
                                        class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="Masukkan no.tlp..." value="<?php echo e($dosen->no_telp); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="email" name="email"
                                        class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="Masukkan email..." value="<?php echo e($dosen->email); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
