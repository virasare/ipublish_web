                                        ...
                                        <select id="dosen-pembimbing" class="dosen-select py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php $__currentLoopData = $dosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->nama_dosen); ?>"><?php echo e($row->nama_dosen); ?></option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchUserData() {
                fetch('<?php echo e(route('users.publikasi')); ?>', {
                    headers: {
            ...
            function handleFinish() {
                if (currentStepPub === 2) {
                    ...
                    fetch('<?php echo e(route('submit.form.pub')); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
...
<?php endif; ?>
<?php /**PATH /Users/kadekwiradnyana/Herd/PKL/resources/views/users/publikasi.blade.php ENDPATH**/ ?>