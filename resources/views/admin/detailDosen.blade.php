                    ...
                    <div class="sm:col-span-12 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="nidn" name="nidn" class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan NIDN..." value="{{ $dosen->NIDN }}"> 
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="nama" name="nama" class="py-3 mt-4 block w-full text-gray-700  bg-gray-100 border-gray-100 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan nama dosen..." value="{{ $dosen->nama_dosen }}"> 
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
