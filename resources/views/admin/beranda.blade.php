                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-neutral-900 dark:even:bg-neutral-800">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-400 ">{{ $row->title }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-normal text-sm text-gray-400">{{ $row->body }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-400">
                                <a href="{{ asset('storage/documents/'.$row->file) }}" target="_blank">{{ $row->file }}</a>   
                            </td>
                            <td class="size-px whitespace-nowrap py-3">
                                <div class="max-w-xs flex flex-col items-center rounded-lg shadow-sm space-y-1">
                                    @if(isset($row->slug))
                                    <a href="{{ route('beranda.edit', ['slug' => $row->slug]) }}"
                                    ...
                                    <form id="deleteForm" action="{{ route('admin.beranda.delete', ['slug' => $row->slug]) }}" method="POST" class="w-full inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" 
